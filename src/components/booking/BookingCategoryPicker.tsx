      ...
      <div className="flex justify-center gap-3 sm:hidden">
        ...
        {categories.slice(0, 2).map((cat) => (
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl font-semibold text-xs transition-all duration-300 bg-[hsl(45,70%,50%)]/80 text-black border-2 border-transparent hover:bg-[hsl(45,70%,45%)] hover:border-black/20 min-w-[120px] max-w-[135px]"
          >
