...
export function HiveOfficeCards({ onRequestOffice }: Props) {
  ...
  const getDisplayInfo = (code: string): { label: string; subtext?: string; displayCode: string } => {
    switch (code) {
      case "P1": return { label: "Private Office P1", subtext: "Second Floor", displayCode: "P1" };
      case "P2": return { label: "Private Office P2", subtext: "Second Floor", displayCode: "P2" };
      case "S1": return { label: "Premium Office S1", subtext: "First Floor", displayCode: "S1" };
      case "S2": return { label: "Premium Office S2", subtext: "First Floor", displayCode: "S2" };
