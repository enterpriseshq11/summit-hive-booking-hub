...
import { Dumbbell, Check, CreditCard, CheckCircle, ArrowRight, Phone, MapPin, Star, Users, Clock } from "lucide-react";
...
const TIERS = [
  {
    id: "standard", name: "Standard Monthly", price: 49, interval: "month",
    priceId: "price_1TIbZkPFNT8K72RIdqWNuuos",
    features: ["Full gym access", "Group fitness classes", "Locker room access", "Free parking"],
    popular: false,
  },
  {
    id: "premium", name: "Premium Monthly", price: 79, interval: "month",
    priceId: "price_1TIbZmPFNT8K72RICpYvA3rO",
    features: ["Everything in Standard", "Monthly personal training session", "Nutrition consultation", "Priority class booking", "Guest passes (2/month)"],
    popular: true,
  },
  {
    id: "day_pass", name: "Day Pass", price: 15, interval: "day",
    priceId: "price_1TIbZnPFNT8K72RI1LWCNjQM",
    features: ["Full gym access for one day", "Group classes included", "Locker room access"],
    popular: false,
  },
];
...
export default function JoinFitness() {
  ...
  const handleSubmit = async () => {
    ...
    if (!healthAcknowledged) {
      toast.error("Please acknowledge the health statement.");
      return;
    }
    if (!tier) return;
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <Button onClick={handleSubmit} className="flex-1 bg-accent text-accent-foreground hover:bg-accent/90" disabled={isSubmitting}>
