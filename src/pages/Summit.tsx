...
export default function Summit() {
  ...
  const victoriaSpecialties = [
    "Personalized Event Planning Support",
    "Venue Walkthroughs & Layout Guidance",
    "Capacity Planning & Event Logistics",
    "Clear Pricing & Booking Coordination"
  ];
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <img 
                  ...
                  style={{ maxHeight: "clamp(320px, 50vw, 500px)" }}
                />
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-4 mb-6">
              <img src={e3Logo} alt="E³ Logo" className="h-16 w-auto" />
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-10">
              {[
                { title: "Elevated Space", desc: "Premium finishes and flexible layouts designed for any vision" },
                { title: "Elevated Service", desc: "Dedicated coordination from first inquiry to final toast" },
                { title: "Elevated Execution", desc: "Every detail managed so you can focus on the moment" },
              ].map((pillar, i) => (
                <Card key={i} className="bg-primary/5 border-accent/20">
      ...
      <section id="venue" className="py-20 container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-12">
          {venueHighlights.map((highlight) => {
            ...
            return (
              <Card key={highlight.id} className="shadow-premium hover:shadow-premium-hover transition-all hover:border-accent/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {[
            ...
            <Card 
              key={i}
              className="aspect-square bg-gradient-to-br from-accent/5 to-muted/20 border-accent/10 flex flex-col justify-center hover:border-accent/30 transition-colors"
            >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="space-y-3 mb-8">
                  {victoriaSpecialties.map((specialty, i) => (
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Button 
                    ...
                    data-event="summit_victoria_cta_click"
                  >
                    <CalendarDays className="h-5 w-5 mr-2" />
                    Book with Victoria
                  </Button>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {testimonials.map((testimonial, i) => (
              <Card key={i} className="shadow-premium relative overflow-hidden hover:shadow-premium-hover transition-shadow">
