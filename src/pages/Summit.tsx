      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-primary">
        ...
        <div className="container relative z-10 py-16">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex justify-center lg:justify-end lg:-mt-8 lg:translate-x-24 lg:translate-y-6 xl:translate-y-14 2xl:translate-y-18">
              <div className="relative transform scale-100 md:scale-110 lg:scale-[1.32]">
