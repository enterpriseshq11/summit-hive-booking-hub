          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <img alt="The Summit Event Center - Elevate Every Event" className="relative w-full max-w-2xl lg:max-w-3xl drop-shadow-2xl object-contain opacity-100" style={{
                maxHeight: "clamp(400px, 60vw, 650px)"
